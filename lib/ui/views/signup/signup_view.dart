                      ...
                      children: [
                        ...
                        _buildAnimatedFormField(
                          child: FilledBtn(
                            ...
                            semanticLabel: 'Proceed to email verification',
                          ),
                          delay: 1100.ms,
                        )
                            .animate()
                            .shimmer(delay: 1200.ms, duration: 1000.ms, color: Colors.white.withOpacity(0.3)),
                                ...
                                children: [
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () => model.navigationService.navigateToLoginView(),
                                  )
                                ],
                              ),
                              semanticsLabel: 'Log in link for existing users',
                            ),
                          ),
                          delay: 1200.ms,
                        ),
