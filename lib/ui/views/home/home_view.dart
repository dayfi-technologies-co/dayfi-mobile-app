...
import 'package:dayfi/ui/views/home/bottom_sheets/dayfi_transfer_id_bottomsheet.dart';
...
// Constants
class _HomeViewConstants {
  // Colors
  static const Color primaryColor = Color(0xff5645F5);
  static const Color secondaryColor = Color(0xff2A0079);
  static const Color backgroundColor = Color(0xffF6F5FE);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color successColor = Color(0xff00AFF5);
  static const Color warningColor = Color(0xffFFB97D);
  static const Color errorColor = Color(0xffFF897D);
...
/// Home view widget that displays the main dashboard with wallet information,
/// transaction history, and quick action buttons.
///
/// This view includes:
/// - User profile and notifications in the app bar
/// - Wallet balance cards with funding options
/// - Quick action buttons for Send and Swap
/// - Transaction history list
/// - "Let's get you started" checklist
class HomeView extends StackedView<HomeViewModel> {
  ...
  Widget builder(BuildContext context, HomeViewModel viewModel, Widget? child) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return AppScaffold(
          backgroundColor: _HomeViewConstants.backgroundColor,
          body: SafeArea(child: _buildHomeContent(context, viewModel, model)),
        );
      },
    );
  }

  /// Builds the app bar with user profile and notifications
  AppBar _buildAppBar(
        ...
        child: Row(
          children: [
            Padding(
              ...
              child: CircleAvatar(
                radius: _HomeViewConstants.avatarRadius,
                backgroundColor: _HomeViewConstants.whiteColor,
            ...
            Text(
              ...
              style: const TextStyle(
                ...
                letterSpacing: 0.3,
                color: _HomeViewConstants.secondaryColor,
              ),
            ),
          ],
        ),
          ...
          child: InkWell(
            ...
            child: CircleAvatar(
              ...
              child: SvgPicture.asset(
                ...
                height: _HomeViewConstants.iconSize,
  ...
  /// Builds the circular action buttons for Send and Swap
  ...
  /// Builds an individual circular action button
  Widget _buildCircularActionButton(
    ...
    return GestureDetector(
      onTap: onTap,
      child: Container(
        height: _HomeViewConstants.buttonHeight.h,
        // width: double.infinity,
        // width: MediaQuery.of(context).size.width * .4165,
        decoration: BoxDecoration(
          color: _HomeViewConstants.backgroundColor,
          border: Border.all(
            width: 0.25,
            color: _HomeViewConstants.primaryColor,
          ),
  ...
  /// Builds a rotated icon based on the action type
  ...
  /// Builds the home content based on loading state
  Widget _buildHomeContent(
    ...
    if (model.hasError) {
      return Center(child: Text(model.error.toString()));
    }
    ...
    return _buildBody(context, viewModel, wallet, model);
  }

  /// Builds the main body content of the home view
  Widget _buildBody(
    BuildContext context,
    HomeViewModel viewModel,
    Wallet wallet,
      ...
      child: Column(
        children: [
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13.00.sp,
                    fontWeight: FontWeight.w600,
                    fontFamily: _HomeViewConstants.fontFamilyBold,
                    letterSpacing: 0.3,
          ...
          Padding(
              ...
              .animate()
              .fadeIn(
                delay: _HomeViewConstants.initialDelay,
                duration: _HomeViewConstants.animationDuration,
                curve: _HomeViewConstants.animationCurve,
              )
              .slideY(
                begin: 0.3,
                end: 0,
  ...
  /// Builds a balance card widget for displaying wallet information
  ...
  /// Builds a horizontal scrollable page view of balance cards
  ...
  /// Resolves the appropriate flag asset for a given currency
  ...
  /// Builds the "Let's get you started" checklist widget
  ...
  /// Builds a transaction list item widget
          ...
          children: [
            ListTile(
              ...
              contentPadding: EdgeInsets.symmetric(
                horizontal: _HomeViewConstants.paddingLarge,
              ),
              leading: _buildTransactionIcon(transaction),
              title: _buildTransactionTitle(transaction),
              subtitle: _buildTransactionSubtitle(transaction),
              trailing: _buildTransactionTrailing(transaction),
            ),
            Divider(
              color: Colors.grey.shade300,
              height: 1,
              indent: _HomeViewConstants.paddingLarge,
              endIndent: _HomeViewConstants.paddingLarge,
              thickness: 1,
            ),
          ],
        )
  ...
  Widget _buildTransactionIcon(WalletTransaction transaction) {
    return CircleAvatar(
      radius: 20,
      backgroundColor:
          transaction.type == 'card_to_wallet'
              ? _HomeViewConstants.successColor.withOpacity(.1)
              : _HomeViewConstants.warningColor.withOpacity(.25),
      child: Transform.rotate(
        angle: !transaction.type.contains("card_to_wallet") ? 0 : 3.12,
        child: SvgPicture.asset(
          'assets/svgs/arrow-narrow-down.svg',
          color:
              transaction.type == 'card_to_wallet'
                  ? _HomeViewConstants.successColor
                  : _HomeViewConstants.errorColor,
          height: _HomeViewConstants.smallIconSize,
        ),
      ),
    );
  }

  /// Builds the transaction title
  Widget _buildTransactionTitle(WalletTransaction transaction) {
    return Text(
      transaction.recipientWalletId.toString() == "null"
          ? "Bale Gary"
          : transaction.recipientWalletId.toString(),
      style: TextStyle(
        fontSize: 16.sp,
        fontWeight: FontWeight.w600,
        height: 1.450,
  ...
  /// Builds the transaction subtitle
  Widget _buildTransactionSubtitle(WalletTransaction transaction) {
    return Text(
  ...
  /// Builds the transaction trailing widget
  Widget _buildTransactionTrailing(WalletTransaction transaction) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.end,
      children: [
        Text(
          "${transaction.type == 'card_to_wallet' ? '+' : '-'} ₦${NumberFormat("#,##0.${'0' * 2}", 'en_US').format(double.parse(transaction.amount))}",
        ...
        Text(
          DateFormat.jm().format(DateTime.parse(transaction.createdAt)),
          style: TextStyle(
            fontSize: 12,
            fontWeight: FontWeight.w600,
            letterSpacing: .1,
  ...
  /// Shows the receive funds notice bottom sheet
                      ...
                      Align(
                        ...
                        child: InkWell(
                          ...
                          child: SvgPicture.asset(
                            ...
                            color: _HomeViewConstants.primaryColor, // innit
                            height: 28,
                          ),
                        ),
                      ),
      ...
      children: [
        ...
        Opacity(
          ...
          child: AnimatedSwitcher(
            duration: _HomeViewConstants.shortAnimationDuration,
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Color(0xff2A0079).withOpacity(0.15)),
              ),
              duration: _HomeViewConstants.shortAnimationDuration,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children:
                    viewModel.currencies.asMap().entries.map((entry) {
                      ...
                      return InkWell(
                            onTap: () {
                              if (isUsd) {
                                setState(
                                  () => viewModel.showCurrencyOptions = false,
                                );
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Image.asset(currency.icon, height: 22),
  ...
  void showDayfieIdInputBottomSheet(
    ...
    showModalBottomSheet(
      ...
      builder:
          (context) =>
              DayfiTransferIDBottomSheet(viewModel: viewModel, wallet: wallet),
    );
  }
  ...
  Widget _buildBottomSheetContent(
    ...
    BuildContext context,
    HomeViewModel viewModel,
    Widget Function(BuildContext, HomeViewModel, StateSetter, Wallet)
    contentBuilder,
    Wallet wallet,
  ) {
    return StatefulBuilder(
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return _buildBottomSheetContent(
          ...
          context,
          viewModel,
          _buildSelectPaymentMethodContent,
          wallet,
        );
      },
    );
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return _buildBottomSheetContent(
          ...
          context,
          viewModel,
          _buildSelectTransferMethodContent,
          wallet,
        );
      },
    );
  ...
  void _showDayfiBottomSheet(
    ...
    showModalBottomSheet(
      ...
      // duration: Duration.zero),
      builder:
          (context) => DayfiIDBottomSheet(viewModel: model, wallet: wallet),
    );
  }
                    ...
                    : InkWell(
                      onTap: () {
                        ...
                        paymentMethod.name == "Via Debit Card" ||
                            ...
                            ? _showDayfiBottomSheet(context, viewModel, wallet)
                            : paymentMethod.name == "Via Bank Transfer"
                            ...
                            : Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DigitalDollarView(),
                              ),
                            );
                      },
                      child: AnimatedContainer(
                              ...
                              child: Row(
                                ...
                                children: [
                                  CircleAvatar(
                                    ...
                                    child:
                                        paymentMethod.icon.contains("svg")
                                            ? SvgPicture.asset(
                                              paymentMethod.icon,
                                              height: 22,
                                              color: Color(0xff5645F5), // innit
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children:
              transferMethods.map((paymentMethod) {
                return InkWell(
                  onTap:
                      paymentMethod.name == "Via Dayfi-ID"
                          ? () => showDayfieIdInputBottomSheet(
                            context,
                            viewModel,
                            wallet,
                          )
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  // crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset("assets/images/idea.png", height: 22),
                    SizedBox(width: 10),
                    Expanded(
                      child: Text(
