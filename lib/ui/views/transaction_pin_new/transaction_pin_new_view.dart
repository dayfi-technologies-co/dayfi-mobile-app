...
import 'transaction_pin_new_viewmodel.dart';

class TransactionPinNewView extends StackedView<TransactionPinNewViewModel> {
  final String? oldPIN;
  const TransactionPinNewView(this.oldPIN, {super.key});

  @override
  Widget builder(
    BuildContext context,
    TransactionPinNewViewModel viewModel,
    Widget? child,
  ) {
    return AppScaffold(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              verticalSpace(12),
              const Text(
                "Enter a new transaction PIN that'll be used for your transactions",
                style: TextStyle(
                  fontFamily: 'Karla',
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
              ...
              SizedBox(
                child: FilledBtn(
                  onPressed: viewModel.isPinValid
                      ? viewModel.navigateToConfirmPin
                      : null,
  ...
  @override
  TransactionPinNewViewModel viewModelBuilder(BuildContext context) =>
      TransactionPinNewViewModel();
}
