...
class WalletsView extends StackedView<WalletsViewModel> {
          ...
          body: SafeArea(
            child:
                model.isLoading
                    ...
                    : _buildBody(context, viewModel, model),
          ),
        );
      },
    );
  ...
  @override
  WalletsViewModel viewModelBuilder(BuildContext context) => WalletsViewModel();
