    ...
    return Column(
      children: [
        ...
        _buildPaymentMethodOption(
          title: 'Bank Transfer',
          description:
              'Send up to ${sendState.sendCurrency} 15,000,000.00 via virtual account. Payer name must match your registered name.',
